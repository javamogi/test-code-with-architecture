...
class UserControllerTest {
    ...
    void 사용자는_특정_유저의_정보를_개인정보는_소거된채_전달_받을_수_있다() {
        ...
        assertThat(result.getBody().getEmail()).isEqualTo("pakoh200@naver.com");
        assertThat(result.getBody().getNickname()).isEqualTo("javamogi");
    ...
    void 사용자는_인증_코드로_계정을_활성화_시킬_수_있다() {
        ...
        // when
        ResponseEntity<Void> result = testContainer.userController.verifyEmail(1, "aaaaaa-aaaa-aaaa-aaaa-aaaaaaaa");
    ...
    void 사용자는_인증_코드가_일치하지_않을_경우_권한_없음_에러를_내려준다() {
        ...
        // then
        assertThatThrownBy(() -> {
            testContainer.userController.verifyEmail(1, "aaaaaa-aaaa-aaaa-aaaa-aaaaaaaab");
...
//                .build();
        ...
        // when
        ResponseEntity<MyProfileResponse> result = testContainer.userController.getMyInfo("pakoh200@naver.com");
    ...
    void 사용자는_내_정보를_수정할_수_있다() {
        ...
        // when
        ResponseEntity<MyProfileResponse> result = testContainer.userController.updateMyInfo("pakoh200@naver.com", UserUpdate.builder()
                        .address("Seoul")
                        .nickname("mogijava")
                .build());
        ...
        assertThat(result.getBody()).isNotNull();
        assertThat(result.getBody().getEmail()).isEqualTo("pakoh200@naver.com");
        assertThat(result.getBody().getNickname()).isEqualTo("mogijava");
