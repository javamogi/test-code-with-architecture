...
class UserControllerTest {
    ...
    void 사용자는_특정_유저의_정보를_개인정보는_소거된채_전달_받을_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/users/1"))
                ...
                .andExpect(jsonPath("$.email").value("pakoh200@naver.com"))
                .andExpect(jsonPath("$.nickname").value("javamogi"))
    ...
    void 사용자는_인증_코드로_계정을_활성화_시킬_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/users/2/verify")
                        .queryParam("certificationCode", "aaaaaa-aaaa-aaaa-aaaa-aaaaaaab"))
    ...
    void 사용자는_인증_코드가_일치하지_않을_경우_권한_없음_에러를_내려준다() throws Exception {
        ...
        // then
        mockMvc.perform(get("/api/users/2/verify")
                        .queryParam("certificationCode", "aaaaaa-aaaa-aaaa-aaaa-aaaaaaac"))
    ...
    void 사용자는_내_정보를_불러올_때_개인정보인_주소도_갖고_올_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/users/me")
                        .header("EMAIL", "pakoh200@naver.com"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(1))
                .andExpect(jsonPath("$.email").value("pakoh200@naver.com"))
                .andExpect(jsonPath("$.nickname").value("javamogi"))
